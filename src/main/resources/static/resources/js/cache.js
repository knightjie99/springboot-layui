    ...
    function lockPage(){
        layer.open({
            ...
            content : '<div class="admin-header-lock" id="lock-box">'+
                            '<div class="admin-header-lock-img"><img id="icon3" src="/resources/images/face.jpg" class="userAvatar"/></div>'+
            ...
            shade : 0.9,
            success : function(){
                var originPath=localStorage.getItem("head");
                if(originPath!=null&&originPath!=""){
                    $('#icon3').attr('src','/file/showImageByPath?path='+originPath);
                }
            }
        })
