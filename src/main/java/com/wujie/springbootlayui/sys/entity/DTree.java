...
//    private List<CheckArr> checkArr = new ArrayList<CheckArr>();
    ...
    public DTree(String id, String parentId, String title, Boolean spread, Object basicData,String checkArr, List<DTree> children) {
        this.id = id;
    ...
    public DTree(String id, String parentId, String title, Boolean spread) {
        this.id = id;
        this.parentId = parentId;
        this.title = title;
        this.spread = spread;
